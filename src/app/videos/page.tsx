...
import { ArrowRight, Icon, Youtube } from "lucide-react";
...
export default function Video() {
  return (
    <main className="flex flex-col justify-center items-center m-auto px-5 sm:px-10 max-w-screen-2xl">
      ...
      <h1 className="md:p-12 flex w-full justify-center items-center">
        More videos coming soon
        <span>
          <ArrowRight />
        </span>
        <Link href="https://www.youtube.com/@marlonethedev" className="mx-2">
          <Button className="bg-red-700 dark:text-white"><Youtube className="pr-1"/>subscribe</Button>
        </Link>
      </h1>
